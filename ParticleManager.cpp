...
ParticleManager::VertexPos ParticleManager::vertice[vertexCount];
...
void ParticleManager::CreateModel()
{
	...
	for (int i = 0; i < vertexCount; i++) {
		...
		vertices[i].posx.x = (float)rand() / RAND_MAX * md_width - md_width / 2.0f;
		vertices[i].posx.y = (float)rand() / RAND_MAX * md_width - md_width / 2.0f;
		vertices[i].posx.z = (float)rand() / RAND_MAX * md_width - md_width / 2.0f;
	}
